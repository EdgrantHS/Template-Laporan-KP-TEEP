...
% Set global paragraph indentation
\setlength{\parindent}{1cm}  % Indent every paragraph by 1cm
...
% Ensure the first paragraph after a section or chapter heading is indented
